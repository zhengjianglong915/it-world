...
<div align="center"> <img src="../images/15282967759984.jpg" width="400" /> </div>
...
分别按1x和2x速度遍历，总会相遇。假设环长为n。
容易知道，当1x的指针p1和2x的指针p2相遇时，p1走了x步，p2走了2x步，而p2比p1多走的，有两部分：
...
https://www.cnblogs.com/zjutzz/p/6506357.html


[解题笔记（30）——找含单链表的环入口点(转网上某位高手的解法)](https://blog.csdn.net/wuzhekai1985/article/details/6725263)


思考两个问题：

1. 为什么速度为1 和速度为2是可以相遇？为什么相遇的时候慢指针没有走过一圈？
2. 为什么fast移动步长为2，low移动步长为1，则在low进入环后继续绕环遍历一周之前fast必然能与low重合？
2. 速度N和M是否可以相遇，需要满足什么条件？
3. 快慢指针满足什么条件可以相遇？为什么？
...
https://blog.csdn.net/derrantcm/article/details/46838835
